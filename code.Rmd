...
chart.Correlation(daily_dataset.consumption[, -1], histogram = TRUE, method = "pearson")
chart.Correlation(daily_dataset.consumption[, -1], histogram = TRUE, method = "kendall")
chart.Correlation(daily_dataset.consumption[, -1], histogram = TRUE, method = "spearman")
